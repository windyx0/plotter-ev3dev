...
## Backend Setup (PC / Smartphone)

All heavy image processing happens on the server.

### Method 1: Native Android App (Easiest!)
If you have an Android smartphone, you don't need to install Python or use the terminal.
Simply download and install our pre-built APK: `release/plott3r_android_app.apk`. The app has a built-in Python engine, works entirely offline locally, and completely replaces the PC server!

### Method 2: PC and Termux Scripts

For convenience, we have prepared installation scripts for various systems.
